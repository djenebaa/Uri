    ...
    if (response.ok) {
      ...
      if (errorData.errors) {
        if (errorData.errors.username)
          backendErrors.username = errorData.errors.username[0];
        if (errorData.errors.email)
          backendErrors.email = errorData.errors.email[0];
        if (errorData.errors.password1)
          backendErrors.password1 = errorData.errors.password1[0];
        if (errorData.errors.password2)
          backendErrors.password2 = errorData.errors.password2[0];
      }
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {errorMessages.password1 && (
                <p className="error-message">{errorMessages.password1}</p>
              )}
            </div>
            <div className="space-y-2">
              ...
              {errorMessages.password2 && (
                <p className="error-message">{errorMessages.password2}</p>
              )}
            </div>
          </CardContent>
          <CardFooter className="flex flex-col">
            <Button
              type="submit"
              className="text-white px-4 py-2 rounded-md transition-colors duration-300 hover:bg-slate-700 active:bg-pink-700"
            >
              Register
            </Button>
          </CardFooter>
